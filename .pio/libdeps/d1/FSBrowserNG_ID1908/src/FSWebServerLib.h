...
#define CONNECTION_LED 14 // Connection LED pin (Built in). -1 to disable
#define AP_ENABLE_BUTTON 13 // Button pin to enable AP during startup for configuration. -1 to disable

#define AP_ENABLE_TIMEOUT 30 // (Seconds, max 255) If the device can not connect to WiFi it will switch to AP mode after this time. -1 to disable
